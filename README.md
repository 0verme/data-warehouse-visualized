...
按主课程顺序学习第 **01 章** 到第 **11 章**。这条路线从业务系统和一张报表开始，经过建模、指标、SQL 加工、调度、质量、血缘、治理、湖仓、数据服务和性能；第 **12 章** 综合实战目前处于规划中。
...
当前课程定义包含 **12 个章节、53 节课程**：其中 **52 节已上线，1 节规划中**。按已上线课程的实验入口计，当前有 **52 个交互实验入口**，对应 **21 类实验工作台**。各章课程数量和状态如下：
